...
憑證頁可參考 `smpebble/vlei-sandbox` 中 KERI／ACDC／vLEI 的可信根釘選、內容可驗證識別、授權 edge、逐層撤銷與自我完備呈現包概念，用來解釋「授權是被鏈結出來的，不是被宣稱出來的」。

但 vLEI 適用於法人及組織角色，不能把自然人民眾資格憑證直接稱為 vLEI。簡報應標示為設計概念參考，且不宣稱目前 Mock Credential 已符合 ISO 17442-3。
